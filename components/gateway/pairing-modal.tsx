...
export function PairingModal({
  ...
  // Poll for pairing status when modal is open and pairing is pending
  useEffect(() => {
  ...
  const handleCheckPaired = async () => {
    ...
    try {
      ...
      if (data.status === 'pending') {
        ...
        setError(
          data.error || 'Gateway is not connected yet. Please approve the pairing request on your gateway.'
        )
      }
    } catch (err) {
                ...
                <details className="mt-3 bg-gray-100 rounded p-3">
                  ...
                  <div className="mt-3 space-y-3">
                    ...
                    <div>
                      ...
                      <CommandBlock
                        command="openclaw devices approve <deviceId>"
                        commandId="approve-id"
                        copiedCommand={copiedCommand}
                        onCopy={copyToClipboard}
                        size="sm"
                      />
              ...
              <details className="mt-4">
                ...
                <div className="mt-3 space-y-3 text-sm text-gray-600">
                  ...
                  <div>
                    ...
                    <CommandBlock
                      command="journalctl --user -u openclaw -f"
                      commandId="logs"
                      copiedCommand={copiedCommand}
                      onCopy={copyToClipboard}
                      size="sm"
